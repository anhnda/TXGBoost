"""
XGBoost BASELINE: [Last Value + Static Context] -> XGBoost

Simple baseline without any reinforcement learning or RNN components.
Just extracts last values and static features, then trains XGBoost.
...
def main():
    print("="*80)
    print("XGBoost BASELINE: [Last Value + Static Context]")
    print("="*80)
    ...
    ax.set_title("XGBoost Baseline: Last Value + Static Context", fontsize=14, fontweight='bold')
    ...
    plt.savefig("result/xgboost_baseline.png", dpi=300)
    print("\nPlot saved to result/xgboost_baseline.png")
